        ...
        <div className="p-6 bg-gradient-to-br from-slate-100 via-white to-slate-200 min-h-screen">
                    ...
                    <DialogContent className="rounded-2xl shadow-xl backdrop-blur-md border bg-white/70">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-sm text-muted-foreground">
                                Remplissez les informations de l'événement pour l'ajouter au calendrier.
                            </DialogDescription>
                        </DialogHeader>
            ...
            <div className="grid grid-cols-7 gap-4">
                {daysInMonth.map((day) => (
                    <div
                        key={day}
                        className={`rounded-2xl p-3 h-44 flex flex-col justify-between bg-white/80 shadow-md backdrop-blur-sm transition-transform hover:scale-[1.015] ${events[day] ? "ring-1 ring-purple-300" : ""
                            }`}
                    >
